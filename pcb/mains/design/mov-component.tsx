...
export const movCapture = {
  mpn: "TMOV14RP175EL2T7",
  footprint: "CrystalShim:TMOV14RP175EL2T7_RoundSlot",
  source:
  ...
  installedAcceptance: {
    ...
    height: 27,
    topMax: 26,
    crimpSeatAboveBoard: { min: 0.5, max: 1 },
    tailAndSolderBelowBoardMax: 2,
    yawMaxDegrees: 20,
    leanMaxDegrees: 5,
    basis:
      "Project final-assembly acceptance limits, including measurement error, for the entire actual body, coating, crimps, leads and solder. No manufacturer common body offset Cy is guaranteed. Whole-volume inspection is required; yaw, lean and seating limits alone do not establish fit.",
  },
  ...
  assembly:
    "Factory outer-crimp leads only; no forced reshaping. Use a removable bare-lead support and board-referenced non-contact gauge; do not load the coating or rely on the crimp bridging the slot. Hand solder after reflow with lead heat sinking and independently controlled seating. No stencil paste. Check the full accepted volume before and after soldering, including actual board thickness and tail projection. Finished-slot process, solder/insulation clearance, enclosure fit and physical acceptance remain open. See docs/design/mov-capture.md.",
} as const;
