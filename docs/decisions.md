...
| D-15 | Settings interface | Confirmed and linked: ESP-hosted local settings, schedule, thresholds, response timing and Pushover credential actions; physical calibration workflow and first-configuration encoder remain | Schedule, calibration, timing and Pushover provisioning workflow |
