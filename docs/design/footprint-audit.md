...
| BOM / part | Status | Installed candidate and checked geometry | Action before capture release |
| --- | --- | --- | --- |
| BOM-03 IRM-10-5 | source model captured | `Converter_ACDC:Converter_ACDC_MeanWell_IRM-05-xx_THT` has body/fab extents 45.7 x 25.4, 1.5 mm drills, and pads 1=(0,0), 2=(0,10.75), 3=(38.5,10.75), 4=(38.5,2.75). | Source CrystalShim:IRM_10_5 now preserves that mapping with 1.5 mm drills and 3 mm lands. Native origin/mask/paste and assembly review remain. |
| BOM-04 G5RL-1A-TV8 DC5 | source model captured | No G5RL footprint is installed. The selected drawing requires four 1.3 mm finished holes: pin 1=(23.5,0), pin 5=(23.5,7.5), pin 3=(0,0), pin 4=(3.5,7.5), with a 29.0 x 12.7 mm maximum body. | Source CrystalShim:G5RL_1A_TV8 uses 2.8 mm lands. The contact pins are staggered by 3.5 mm; 23.5 mm coil-to-pin-3 is 20+3.5 and not an independently toleranced dimension. Preserve the 8 mm isolation boundary. |
| BOM-25 1N4007-E3/54 | source model captured | `Diode_THT:D_DO-41_SOD81_P10.16mm_Horizontal` has pads 1 and 2 at (0,0) and (10.16,0), 1.1 mm drills and 2.2 mm lands. | Source uses 2.6 mm lands, 1.1 mm finished holes and square cathode pin 1. Verified maximum body is 5.2 x 2.7 mm and wire 0.86 mm. Forming, standoff and native mask/paste remain review obligations. |
| BOM-13 TMOV14RP175EL2T7 | custom-required | The nearest installed `Varistor:RV_Disc_D15.5mm_W8mm_P7.5mm` has pad 1=(0,0), pad 2=(7.5,4.4), 0.8 mm drills and 1.8 mm lands. | Primary drawing review found staggered leads and invalidated the prior two 1.1 mm holes. Prefer the factory outer-crimp L2T7 part with the qualified round-hole/slot proposal in [MOV capture](mov-capture.md). Native slot capability is checked; complete body pose, fabrication and soldering remain open. |
| BOM-24 PR02FS0201000KA100 | source model captured | The nearest installed `Resistor_THT:R_Axial_DIN0207_L6.3mm_D2.5mm_P15.24mm_Horizontal` has 15.24 mm pad spacing, 0.8 mm drills and 1.6 mm lands, but a 6.3 x 2.5 mm body. | Source uses 15.24 mm project pitch, 1.1 mm finished holes and 2.6 mm lands. Maximum body is 10.0 x 3.9 mm, coating length 12.0 mm, leads 0.78 +/-0.05 mm. Preserve coating during forming and review standoff/heat clearance. |
| BOM-14 B32921C3473K000 | source model captured | `Capacitor_THT:C_Rect_L13.0mm_W5.0mm_P10.00mm_FKS3_FKP3_MKS4` has pads 1 and 2 at (0,0) and (10,0), 1 mm drills and 2 x 2 lands; fab body is 13.0 x 5.0 mm. | Source preserves the 13 x 5 x 11 mm maximum body and 10 +/-0.4 mm pitch. Custom 1.3 mm finished holes and 2.9 mm lands allow 0.65 mm maximum leads and pitch tolerance. Native mask/paste, actual hole-position tolerance, X2 spacing and assembled standoff remain review obligations. |
| BOM-09, BOM-43, BOM-46, BOM-49 43160-0102/-0103/-0104/-0106 | source models captured | Read-only scan found installed `Connector_Molex:Molex_Sabre_43160-0102_1x02_P7.49mm_Vertical`, `...0103_1x03...`, `...0104_1x04...` and `...0106_1x06...` candidates. Each checked file has two plated-hole rows per circuit at y=-3.18 and 0, duplicate pad numbers, 1.78 mm drills and 7.49 mm pitch, with 3.78 x 3.43 mm copper. The exact manufacturer drawing supports the paired-tail arrangement; it does not establish cross-mating behavior. | [Captured source](mains-header-capture.md) uses 7.493 mm pitch, two 1.78 mm PTHs per circuit, project 3.50 mm circular copper and all 30 tails, including 14 unused tails. Four-angle source/native checks pass. Body-to-tail pose, housing face numbering and cross mating remain qualified open inputs to fit review. |
...
- [Omron G5RL primary archive](https://omronfs.omron.com/en_US/ecb/products/pdf/en-g5rl.pdf): K132-E1-10 1216(0307)(O), p5 G5RL-1A-TV8 four-hole mounting and terminal drawing; SHA-256 `27f89100ce31179247bfdf60fba4d9023c4801e76c6a711461b91cce88293ac5`. Independently inspected actual PDF confirms the 3.5 mm contact stagger. A previous cached `.pdf` was an HTML error and is not source evidence. This older primary drawing establishes geometry; it does not establish current availability.
