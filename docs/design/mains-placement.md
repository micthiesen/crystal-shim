...
J1–J4 change to right-angle Sabre **43160-1102/-1103/-1104/-1106** for side access.
...
filled zones and occupied metal, including unused Sabre contacts. Soldermask is
not insulation. Source/native checks must use the new geometry and actual
right-angle connector metal rather than historical vertical-header envelopes.

Keep filter LINE and LOAD harnesses apart. Side connectors must retain room for
mated housings, latch release and withdrawal under the upper PCB. Route the
